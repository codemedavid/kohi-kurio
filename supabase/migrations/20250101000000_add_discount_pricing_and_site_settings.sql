...
INSERT INTO site_settings (id, value, type, description) VALUES
  ('site_name', 'KOHI + KURIO', 'text', 'The name of the coffee shop'),
  ...
  ('site_description', 'Welcome to KOHI + KURIO - Your premium coffee experience', 'text', 'Short description of the coffee shop'),
